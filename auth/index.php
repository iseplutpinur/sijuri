...
<head>
  ...
  <title>Login &rsaquo; Skripsi - Universitas Padjadjaran.</title>
...
<body>
  <div id="login-page">
    <div class="container">
      ...
      <form class="form-login" action="auth.php" method="POST" style="margin-top:120px">
        <h2 class="form-login-heading"><img src="../assets/img/logo-unpad.png" style="width: 150px; height: 150px"></h2>
  ...
  <script>
    $.backstretch("<?php echo $config['base_url'] ?>../assets/media/img/bg.jpg", {
      speed: 500
    });
  </script>
</body>
