          ...
          <table id="data-pengajuan-judul" class="table table-striped table-bordered table-hover">
            ...
            <tbody>
              ...
              while ($row = mysqli_fetch_array($result)) {
                ...
                $lampiran = $lampiran ? '<a href="../file_up/' . $lampiran . '"  target="_blank">Download</a>' : "Tidak ada";
              ?>
                <tr>
                  <td><?php echo $no; ?></td>
                  ...
                  <td><a href="media.php?action=lihat-judul&nim=<?php echo $row['nim'] ?>" class="btn btn-sm btn-success"><i class="fa fa-external-link"></i> Lihat Detail</a></td>
                </tr>
