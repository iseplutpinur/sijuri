...
<body>
  <div id="login-page">
    <div class="container">
      ...
      <form class="form-login" action="auth.php" method="POST" style="margin-top:120px" autocomplete="nope">
        <div class="form-login-heading text-center logo">
          <img src="../assets/img/logo-unpad.png" style="width:150px; display:block">
        </div>
        <div class="login-wrap">
          <span class="title">Login Mahasiswa</span>
          <?php
          $username = isset($username) ? $username : "";
          if (isset($error)) {
            echo $error;
          } ?>
          <input type="text" name="username" class="form-control" placeholder="Username" required autofocusautocomplete="nope" value="<?php echo $username; ?>">
          <br>
          <input type="password" name="password" class="form-control" placeholder="Password" requiredautocomplete="nope">
  ...
  <script>
    $.backstretch("<?php echo $config['base_url'] ?>assets/img/rektorat-UNPAD.jpg", {
      speed: 500
    });
