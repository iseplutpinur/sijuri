			...
			<div class="col-md-12">
				<div class="panel panel-success" style="box-shadow: 0 2px 5px 0 rgba(0, 0, 0, 0.16), 0 2px 10px 0 rgba(0, 0, 0, 0.12);">
					...
					<div class="panel-body">
						<form action="module/ajukan-judul/update-judul.php" method="POST">
							<input type="hidden" name="nim" value="<?php echo $nim ?>">
							<input type="hidden" name="type" value="edit-judul2">

							<div class="form-group">
								<label for="judul">Judul Skripsi</label>
								<input type="text" name="judul2" class="form-control" placeholder="Masukan Judul Skripsi Anda." value="<?php if (isset($judul)) {
																																			echo $judul;
																																		} ?>"" required>
                            </div>
                            <div class=" form-group">
								<label for="judul">Descriptions Judul</label>
								<textarea rows="5" name="desjudul2" class="form-control" placeholder="Here can be your description" required><?php if (isset($desjudul)) {
																																					echo $desjudul;
																																				} ?></textarea>
							</div>
